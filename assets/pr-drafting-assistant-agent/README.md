# PR Drafting Assistant Agent

An AI agent that extracts PR fields from supplier quotation PDFs, validates procurement policy, drafts compliant purchase requisitions, and routes exceptions to procurement managers
